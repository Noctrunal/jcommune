...
$labelDelete= '<spring:message code="label.delete" htmlEscape="true"/>';
...
$allowPermission = '<spring:message code="permissions.allow" htmlEscape="true"/>';
$restrictPermission = '<spring:message code="permissions.restrict" htmlEscape="true"/>';
